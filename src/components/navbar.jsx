...
const Navbar = () => {
  return (
    <div className="relative z-10 min-w-full px-5 md:min-h-header md:h-header md:px-8 border-b border-transparent">
      <header className="flex justify-between items-center py-4 md:py-0 md:h-header md:min-h-header mx-auto max-w-container">
